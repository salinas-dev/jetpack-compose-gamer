...
import com.salinas.gamermvvm.presentation.screens.details_post.DetailPostScreen
import com.salinas.gamermvvm.presentation.screens.new_post.NewPostScreen
import com.salinas.gamermvvm.presentation.screens.profile_edit.ProfileEditScreen
import com.salinas.gamermvvm.presentation.screens.update_post.UpdatePostScreen
    ...
    navigation(
        ...
        composable(
            ...
            it.arguments?.getString("user")?.let {
                ProfileEditScreen(navController = navController, user = it)
            }
        }
